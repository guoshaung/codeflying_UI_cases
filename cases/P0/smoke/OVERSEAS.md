...
| [CF-P0-INTL-H5-023](overseas-h5/publish/CF-P0-INTL-H5-023.md) | 海外H5 | `publish_agent` | 展示该用户已发布的应用 |
| [CF-P0-INTL-H5-024](overseas-h5/publish/CF-P0-INTL-H5-024.md) | 海外H5 | `publish_agent` | 点击应用名称后操作按钮展示操作功能半屏弹窗 |
| [CF-P0-INTL-H5-025](overseas-h5/publish/CF-P0-INTL-H5-025.md) | 海外H5 | `publish_agent` | 点击弹出分享链接弹窗 |
| [CF-P0-INTL-H5-026](overseas-h5/publish/CF-P0-INTL-H5-026.md) | 海外H5 | `publish_agent` | 点击复制链接可将分享链接复制到剪切板 |
| [CF-P0-INTL-H5-027](overseas-h5/publish/CF-P0-INTL-H5-027.md) | 海外H5 | `publish_agent` | 点击跳转至应用对话页面 |
| [CF-P0-INTL-H5-028](overseas-h5/publish/CF-P0-INTL-H5-028.md) | 海外H5 | `publish_agent` | 点击查看应用进入应用预览页 |
| [CF-P0-INTL-H5-029](overseas-h5/publish/CF-P0-INTL-H5-029.md) | 海外H5 | `publish_agent` | 点击发布应用弹出toast提示 |
| [CF-P0-INTL-H5-030](overseas-h5/publish/CF-P0-INTL-H5-030.md) | 海外H5 | `publish_agent` | 点击预览应用进入应用预览页 |
| [CF-P0-INTL-H5-031](overseas-h5/publish/CF-P0-INTL-H5-031.md) | 海外H5 | `publish_agent` | 点击发布应用弹出toast提示 |
| [CF-P0-INTL-H5-032](overseas-h5/publish/CF-P0-INTL-H5-032.md) | 海外H5 | `publish_agent` | 点击弹出应用名称修改弹窗 |
| [CF-P0-INTL-H5-033](overseas-h5/publish/CF-P0-INTL-H5-033.md) | 海外H5 | `publish_agent` | 点击结束应用发布状态 |
| [CF-P0-INTL-H5-034](overseas-h5/publish/CF-P0-INTL-H5-034.md) | 海外H5 | `publish_agent` | 点击弹出二次确认弹窗 |
