# CF-P0-PC-036 展示用户邀请新用户获得的积分及剩余积分

- 优先级：P0
- 模块：国内主站 / 侧边栏 / 我的权益 / 推荐奖励
- 平台：国内PC
- 执行方式：可自动化
- 问题类型：产品体验
- 用户类型：免费用户 / 付费用户
- 前置条件：固定邀请人已登录；已有一轮成功邀请新用户的测试数据，或本轮生成动态测试手机号完成邀请后再进入我的权益验证；执行后清理测试被邀请人、邀请关系与奖励记录。
...
2. 进入 FM 路径：`国内主站 / 侧边栏 / 我的权益 / 推荐奖励`。
3. 执行原始测试点描述的操作：展示用户邀请新用户获得的积分及剩余积分。
   - 若本轮没有现成邀请奖励数据，先通过动态新手机号完成一次邀请链路。
