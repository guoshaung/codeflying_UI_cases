# CF-P0-INTL-H5-015 默认展示未发布tab应用列表展示用户已完成未发布、开发中的应用
...
2. 进入 FM 路径：`海外H5 / 工作台 / 未发布`。
3. 执行原始测试点描述的操作：默认展示未发布tab应用列表展示用户已完成未发布、开发中的应用。
4. 记录页面状态、URL、关键 DOM、接口结果和截图。

## 预期结果

1. 原始测试点描述的目标结果正确发生：默认展示未发布tab应用列表展示用户已完成未发布、开发中的应用。
