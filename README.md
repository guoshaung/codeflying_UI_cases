...
`cases/P0/smoke/` 当前包含 215 条：国内 PC 68 条、国内 H5 41 条、海外 PC 64 条、海外 H5 42 条。每条用例一个 Markdown，PC 和 H5 分别连续编号。自动化 runner 以 `cases/P0/smoke/README.md` 和其中的 215 个去重 case ID 为准。
